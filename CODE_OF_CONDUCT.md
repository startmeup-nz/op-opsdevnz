...
When an incident does occur, it is important to report it promptly. To report a possible violation, **open a GitHub issue, contact the OpsDev.nz code owner privately (per the SECURITY policy), or email john@startmeup.nz (StartMeUp.nz director)**.
